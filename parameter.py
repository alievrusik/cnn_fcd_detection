...
def get_parameters():
    ...
    parser.add_argument('--use_ae', action='store_true', default=False, 
    ...
    ### patch extraction 
    parser.add_argument('--height', default=16, type=int, help='Height of patches (should be divisible by 8)')
    parser.add_argument('--width', default=32, type=int, help='Width of patches (should be divisible by 8)')
    ...
    parser.add_argument('--latent_size', default=512, type=int, 
                        help='Size of latent code of autoencoder')
    parser.add_argument('--nb_epochs', default=8, type=int)
    parser.add_argument('--nb_epochs_ae', default=8, type=int)
    parser.add_argument('--weight_decay', default=4e-4, type=float)
    parser.add_argument('--weight_of_class', default=2, type=float,
